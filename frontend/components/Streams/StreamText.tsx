...
//str8 text render
export class StreamText extends sComponent<{stateKey:string, objectKey?:string, movingAverage?:number, toFixed?:number}>{
    ...
    componentDidMount() {
        ...
        this.state[this.stateKey] = this.__statemgr.data[this.stateKey];
    }
