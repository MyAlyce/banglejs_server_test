...
import { code, decodeSensorData, testcode, strdecoder } from '../scripts/bangle';
        ...
        initDevice(Devices.BLE.espruino, {
            ...
            ondecoded: (data) => {
                if(decodeMode === 0) {
                    ...
                    if(result) this.loggerRef.current?.log(result);//.parsedData));
                    ...
                    if(result?.parsedData) this.loggerRef.current?.log(JSON.stringify(result.parsedData));
