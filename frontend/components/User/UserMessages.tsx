...
import { WebRTCclient } from '../../scripts/streamclient';
...
export class UserMessages extends sComponent<{streamId:string, hideIcon?:boolean, hideModal?:boolean}> {
  ...
  handleShow = () => {
    (WebRTCclient.rtc[this.props.streamId] as RTCCallInfo).unreadMessages = 0;
  ...
  render() {
    ...
    let chats = (WebRTCclient.rtc[this.props.streamId] as RTCCallInfo).messages;
    let unread = (WebRTCclient.rtc[this.props.streamId] as RTCCallInfo).unreadMessages;
