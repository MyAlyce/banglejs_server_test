...
import { client, WebRTCclient, RTCCallInfo, defaultProfilePic } from '../../scripts/streamclient';
...
export function UserBar(props:{
  ...
  if(props.streamId) {
    call = WebRTCclient.rtc[props.streamId];
    profilePic = (WebRTCclient.rtc[props.streamId] as RTCCallInfo).pictureUrl;
    name = (WebRTCclient.rtc[props.streamId] as RTCCallInfo).firstName + ' ' + (WebRTCclient.rtc[props.streamId] as RTCCallInfo).lastName;
  } else {
