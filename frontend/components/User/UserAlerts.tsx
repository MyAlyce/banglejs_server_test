...
import {  client, splitCamelCase, webrtcData } from '../../scripts/streamclient';
...
export class UserAlerts extends sComponent<{streamId?:string, hideIcon?:boolean, hideModal?:boolean, useActiveStream?:boolean}> {
